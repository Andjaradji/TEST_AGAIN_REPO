    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.iv_winner:
                ...
                LuckyDrawListResponse luckyDrawListResponse = new LuckyDrawListResponse();
                luckyDrawListResponse.setLuckyDraws(completedLuckyDraws);
                intent.putExtra("luckyDraw_winner", JsonUtil.toString(luckyDrawListResponse));
                startActivity(intent);
                break;
        }
    }
...
//                            }
    ...
    private class LoadLuckyDrawAsync extends AsyncTask<Void, Void, ArrayList<LuckyDraw>> {
        ...
        protected ArrayList<LuckyDraw> doInBackground(Void... strings) {
            return StaticGroup.getFilteredLuckyDraw(luckyDraws, sortFilterCondition);
        }
