...
public class WalletBaseFragment extends BaseFragment implements BoxFragmentChangeListener {

    public static final int WALLET_MAIN_FRAGMENT = 20;
//    public static final int WALLET_MAIN_FRAGMENT = 20;

    private FrameLayout mContainer;

    public static WalletBaseFragment newInstance() {
        return new WalletBaseFragment();
    }
