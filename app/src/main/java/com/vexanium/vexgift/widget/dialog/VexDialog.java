...
public class VexDialog extends BaseDialog implements View.OnClickListener {
    ...
    public abstract static class ButtonCallback {
        ...
        @Deprecated
        public void onAny(VexDialog dialog) {
        }

        @Deprecated
        public void onPositive(VexDialog dialog) {
        }

        @Deprecated
        public void onNegative(VexDialog dialog) {
        }

        // The overidden methods below prevent Android Studio from suggesting that they are overidden by developers

        @Deprecated
        public void onNeutral(VexDialog dialog) {
        }
