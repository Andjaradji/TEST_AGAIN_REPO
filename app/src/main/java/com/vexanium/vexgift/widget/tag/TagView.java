...
public class TagView extends RelativeLayout {
    ...
    private void initialize(Context ctx, AttributeSet attrs, int defStyle) {
        ...
        this.lineMargin = (int) typeArray.getDimension(R.styleable.TagView_lineMargin, MeasureUtil.dip2px(this.getContext(), TagConstant.DEFAULT_LINE_MARGIN));
        this.tagMargin = (int) typeArray.getDimension(R.styleable.TagView_tagMargin, MeasureUtil.dip2px(this.getContext(), TagConstant.DEFAULT_TAG_MARGIN));
        this.textPaddingLeft = (int) typeArray.getDimension(R.styleable.TagView_textPaddingLeft, MeasureUtil.dip2px(this.getContext(), TagConstant.DEFAULT_TAG_TEXT_PADDING_LEFT));
        this.textPaddingRight = (int) typeArray.getDimension(R.styleable.TagView_textPaddingRight, MeasureUtil.dip2px(this.getContext(), TagConstant.DEFAULT_TAG_TEXT_PADDING_RIGHT));
        this.textPaddingTop = (int) typeArray.getDimension(R.styleable.TagView_textPaddingTop, MeasureUtil.dip2px(this.getContext(), TagConstant.DEFAULT_TAG_TEXT_PADDING_TOP));
        this.textPaddingBottom = (int) typeArray.getDimension(R.styleable.TagView_textPaddingBottom, MeasureUtil.dip2px(this.getContext(), TagConstant.DEFAULT_TAG_TEXT_PADDING_BOTTOM));
        typeArray.recycle();
    }
    ...
    private void drawTags() {
        ...
        for (Tag item : mTags) {
            ...
            tagView.setTypeface(null, tag.isSelected ? Typeface.NORMAL : Typeface.NORMAL);
...
//            });
//
//            tagLayout.setOnLongClickListener(new View.OnLongClickListener() {
//                @Override
...
//            });
            ...
            if (mWidth <= total + tagWidth + MeasureUtil.dip2px(this.getContext(), TagConstant.LAYOUT_WIDTH_OFFSET)) {
    ...
    private Drawable getSelector(Tag tag) {
        ...
        if (tag.layoutBorderSize > 0) {
            gdNormal.setStroke(MeasureUtil.dip2px(getContext(), tag.layoutBorderSize), tag.layoutBorderColor);
        }
    ...
    public void setLineMargin(float lineMargin) {
        this.lineMargin = MeasureUtil.dip2px(getContext(), lineMargin);
    }
    ...
    public void setTagMargin(float tagMargin) {
        this.tagMargin = MeasureUtil.dip2px(getContext(), tagMargin);
    }
    ...
    public void setTextPaddingLeft(float textPaddingLeft) {
        this.textPaddingLeft = MeasureUtil.dip2px(getContext(), textPaddingLeft);
    }
    ...
    public void setTextPaddingRight(float textPaddingRight) {
        this.textPaddingRight = MeasureUtil.dip2px(getContext(), textPaddingRight);
    }
    ...
    public void setTextPaddingTop(float textPaddingTop) {
        this.textPaddingTop = MeasureUtil.dip2px(getContext(), textPaddingTop);
    }
    ...
    public void settextPaddingBottom(float textPaddingBottom) {
        this.textPaddingBottom = MeasureUtil.dip2px(getContext(), textPaddingBottom);
    }
